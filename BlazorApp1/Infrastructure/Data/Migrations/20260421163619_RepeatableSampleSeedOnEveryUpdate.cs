...
{
    /// <inheritdoc />
    public partial class RepeatableSampleSeedOnEveryUpdate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                CREATE OR REPLACE FUNCTION public.fn_repeatable_seed_reset_history()
                RETURNS trigger
                LANGUAGE plpgsql
                AS $$
                BEGIN
                    IF NEW."MigrationId" LIKE '%_RepeatableSampleSeedOnEveryUpdate' THEN
                ...
                DROP TRIGGER IF EXISTS "TRG_RepeatableSeed_ResetHistory" ON "__EFMigrationsHistory";

                CREATE TRIGGER "TRG_RepeatableSeed_ResetHistory"
                AFTER INSERT ON "__EFMigrationsHistory"
                FOR EACH ROW
                EXECUTE FUNCTION public.fn_repeatable_seed_reset_history();
                """);
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                DROP TRIGGER IF EXISTS "TRG_RepeatableSeed_ResetHistory" ON "__EFMigrationsHistory";
                DROP FUNCTION IF EXISTS public.fn_repeatable_seed_reset_history();
                """);
        }
    }
}
